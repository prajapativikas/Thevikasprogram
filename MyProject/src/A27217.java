...
public class A27217 extends JFrame implements ActionListener 
  { 
  ...
  //  JPasswordField p1, p2;
    ...
    A27217()
     {
       ...
       l4 = new JLabel("Create Passowrd:");
        ...
        /*   l2 = new JLabel("create password:");
            ...
            l4 = new JLabel("Name:");
            l5 = new JLabel("choose your username:");*/
   ...
   /*	Number year = null;
		SpinnerModel value =  
                new SpinnerNumberModel(year, //initial value  
                   1990, //minimum value  
                   2050, //maximum value  
                   1); //step  
    	...
    	SpinnerModel value =  
         ...
         /*  	SpinnerModel value1 =  
              	...
              	JSpinner spinner1 = new JSpinner(value1);   
                      spinner1.setBounds(390,270,50,30); */
                  	...
                  	JSpinner spinner2 = new JSpinner(value2);   
                          spinner2.setBounds(480,270,50,30);        
                      
                          String Month[]={"January","February","March","April","May","June","July","August","September","October","November","December"};        
                          JComboBox cb1=new JComboBox(Month);    
                          cb1.setBounds(390,270,80,30); 
          ...
          //  System.out.println(s9);
            ...
            if (s8.equals(s9))
           {
                ...
                try
               {
                ...
                //    PreparedStatement ps = con.prepareStatement("insert into registration (Name, EmailID, Password, Country, State, PhoneNo) values(?,?,?,?,?,?)");
              //      ps.setString(1, s1);
                   // ps.setString(2, s2);
               //     ps.setString(3, s8);
                  //  ps.setString(4, s5);
