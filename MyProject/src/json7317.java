...
public class json7317 extends JFrame implements ActionListener {
	...
	json7317() {
      ...
      /*  JSONObject obj = new JSONObject();
		...
		String Location[] = {"Select", "India", "Aus", "U.S.A", "England", "Newzealand" };
		JComboBox cb = new JComboBox(Location);
		cb.setBounds(300, 390, 200, 30);
	
		//  Object contents = cb.getSelectedItem();
	      ...
	      //       JSONObject obj = new JSONObject();
	       ...
	       //     System.out.println(obj);
			...
			//	obj3.put("Gender","" );
	          ...
	          JComboBox cb = null;
		//    String y = cb.getSelectedItem().toString();
	           // String x = String.valueOf(cb.getSelectedItem());
