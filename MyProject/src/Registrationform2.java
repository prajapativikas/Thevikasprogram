...
public RegistrationFormDesign1()
{
initComponents();
event();
...
if(name.equals(""))
{
JOptionPane.showMessageDialog(register,"Enter Name");
}
else if(password.equals(""))
{
JOptionPane.showMessageDialog(register,"Enter Father Name");
}
else if(dob.equals(""))
{
JOptionPane.showMessageDialog(register,"Enter Date");
}
else if(dob1.equals(""))
{
JOptionPane.showMessageDialog(register,"Enter Month");
}
else if(dob2.equals(""))
{
JOptionPane.showMessageDialog(register,"Enter Year");
}

else if(mobilenumber.equals(""))
{
JOptionPane.showMessageDialog(register,"Enter Mobile Number");
}

else if(email.equals(""))
{
JOptionPane.showMessageDialog(register,"Enter E-Mail address");
}

else if(area.equals(""))
{
JOptionPane.showMessageDialog(register,"Enter Area");
}

else if(selectedState.equals(""))
{
JOptionPane.showMessageDialog(register,"Select State");
}
else if(nationality.equals(""))
{
JOptionPane.showMessageDialog(register,"Enter Nationality");
}
else if(gender.equals(""))
{
JOptionPane.showMessageDialog(register,"Select gender");
}
else {
...
JOptionPane.showMessageDialog(register,"Enter 10-digit moblie number");
}
}
else {
JOptionPane.showMessageDialog(register,"Enter valid mail ID");
}

}
else
{
JOptionPane.showMessageDialog(register,"Invalid Date");
}
}
...
{
JOptionPane.showMessageDialog(register,"Enter month between 1 and 12");
}
}
else
{
JOptionPane.showMessageDialog(register,"Enter year between 1900 and 2010");
}
}
}
...
if(count==1) {
    ...
    Connection con = DriverManager.getConnection("jdbc:mysql://localhost/vikas", "root", "root");
PreparedStatement st1 = con1.prepareStatement("INSERT INTO registrationform(name,gender,dobb,mobilenumber,email,password,area,state,nationality) VALUES(?,?,?,?,?,?,?,?,?)");
 st1.setString(1, name);
 st1.setString(2, gender);
 st1.setString(3, dobb);
 st1.setString(4, mobilenumber);
 st1.setString(5, email);
 st1.setString(6, password);
 st1.setString(7, area);
 ...
 if(i>0){
	 JOptionPane.showMessageDialog(register,"Data are Registered Successfully");
 }
...
RegistrationFormDesign1 form = new RegistrationFormDesign1();
